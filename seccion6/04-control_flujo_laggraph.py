...
# print(compiled.invoke({"numero": 3}))
# {'numero': 3, 'resultado': 'El numero es impar'}

print(compiled.invoke({"numero": 2})["resultado"])
# El numero es impar



# python seccion6/04-control_flujo_laggraph.py
