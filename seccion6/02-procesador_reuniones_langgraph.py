...
import os
# Comentado para evitar error "_tkinter.TclError: no display name" en Linux sin GUI
...
def transcribe_media_direct(file_path: str) -> str:
    ...
    try:
        ...
        # El modo "rb" en la función open() de Python significa "Read Binary" (Leer en Binario).
...
# python seccion6/02-procesador_reuniones_langgraph.py
